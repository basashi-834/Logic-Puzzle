...
(function (global) {
  ...
  const HELP = '<h2>遊び方</h2>' +
    ...
    '<div><b>③ 線を外す</b><p>つながっている<b>入力側の端子を 2 回タップ</b>すると外れます（1 回目で選択、2 回目で解除）。線を<b>クリックして選び Delete キー</b>、線の<b>右クリック</b>でも消せます。</p></div>' +
    '<div><b>④ スイッチを押す</b><p>入力ブロックの四角い 0 / 1 をクリックすると値が変わり、線と出力ランプの色がその場で変化します。</p></div>' +
    '<div><b>⑤ 部品を消す</b><p>部品を<b>ごみ箱へドラッグ</b>、または<b>ダブルクリック</b>／<b>右クリック</b>。「そうさ」の〈選んだ部品／線を削除〉でも消せます。</p></div>' +
